...
const notifications = [
  ...
  },
  {
    ...
    message:
      "Engagement dropping in 'CSS Masterclass' - 30% decrease in participation",
    time: "2 days ago",
    read: false,
    thumbnailType: "course",
    course: {
  ...
  },
  {
    ...
    title: "Bulk Purchase",
    message:
      "Corporate client purchased 25 licenses for 'Data Science Essentials'",
    time: "2 days ago",
    read: true,
    amount: "$2,499.75",
    thumbnailType: "course",
...
function NotificationItem({
  ...
  const { id, type, title, message, time, read, user, course, thumbnailType } =
    notification;
  return (
    <div
