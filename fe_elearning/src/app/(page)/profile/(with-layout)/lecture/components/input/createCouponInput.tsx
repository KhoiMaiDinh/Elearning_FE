      ...
      <div className="col-span-3 flex flex-col">
        {type !== 'select' ? (
          <Input
            ...
            // className="col-span-3 flex h-10 w-full rounded-md border border-input bg-background px-3 py-auto text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 pt-[2px]"
          />
        ) : (
        ...
        <span className="m-1 font-medium text-[9px] text-redPigment h-[9px]">
